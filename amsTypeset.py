...
os.system("/usr/texbin/pdflatex %s >& /dev/null"%latexFile)
...
print "To view this file, type 'open %s'"%(pdfFile)
...
os.system(" \\rm *.aux *.bbl *.blg *.lof *.lot *.toc *.fff *.ttt %s %s"%(dviFile, psFile))
print "\nI successfully cleaned up after myself. I am a thoughtful little script! And you are an ungrateful bastard!"